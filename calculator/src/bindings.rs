    ...
    pub mod docs {
        pub mod calculator {
            ...
            pub mod calculate {
                ...
                #[doc(hidden)]
                macro_rules! __export_docs_calculator_calculate_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "docs:calculator/calculate#eval-expression")] unsafe extern "C"
                        fn export_eval_expression(arg0 : * mut u8, arg1 : usize,) -> i32
                        { unsafe { $($path_to_types)*::
                        _export_eval_expression_cabi::<$ty > (arg0, arg1) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_docs_calculator_calculate_cabi;
            }
        }
    }
}
...
macro_rules! __export_calculator_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::docs::calculator::calculate::__export_docs_calculator_calculate_cabi!($ty
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:docs:calculator:calculator:encoded world"
)]
#[doc(hidden)]
...
\x19docs:calculator/calculate\x05\x01\x04\0\x1adocs:calculator/calculator\x04\0\x0b\
